...
DescriptorBufferUniform::DescriptorBufferUniform(DescriptorBufferUniform&& other) noexcept
{
...
DescriptorBufferUniform& DescriptorBufferUniform::operator=(DescriptorBufferUniform&& other) noexcept
{
    if (this != &other) {
        buffer = std::move(other.buffer);
        freeIndices = std::move(other.freeIndices);
