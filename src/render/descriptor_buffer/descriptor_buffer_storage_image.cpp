...
DescriptorBufferStorageImage::DescriptorBufferStorageImage(DescriptorBufferStorageImage&& other) noexcept
{
...
DescriptorBufferStorageImage& DescriptorBufferStorageImage::operator=(DescriptorBufferStorageImage&& other) noexcept
{
    if (this != &other) {
        buffer = std::move(other.buffer);
        freeIndices = std::move(other.freeIndices);
