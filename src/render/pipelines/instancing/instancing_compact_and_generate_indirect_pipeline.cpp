...
#include "instancing_compact_and_generate_indirect_pipeline.h"
...
namespace Renderer
{
InstancingCompactAndGenerateIndirectPipeline::InstancingCompactAndGenerateIndirectPipeline() = default;

InstancingCompactAndGenerateIndirectPipeline::~InstancingCompactAndGenerateIndirectPipeline() = default;

InstancingCompactAndGenerateIndirectPipeline::InstancingCompactAndGenerateIndirectPipeline(VulkanContext* context)
    : context(context)
{
...
InstancingCompactAndGenerateIndirectPipeline::InstancingCompactAndGenerateIndirectPipeline(InstancingCompactAndGenerateIndirectPipeline&& other) noexcept
{
...
InstancingCompactAndGenerateIndirectPipeline& InstancingCompactAndGenerateIndirectPipeline::operator=(InstancingCompactAndGenerateIndirectPipeline&& other) noexcept
{
    if (this != &other) {
        pipelineLayout = std::move(other.pipelineLayout);
        pipeline = std::move(other.pipeline);
